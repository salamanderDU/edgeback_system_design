...
from edgeback.features import calculate_opening_range, true_range, calculate_atr, calculate_volume_ratio

@pytest.fixture
def base_time():
    return datetime(2026, 8, 24, 13, 30, tzinfo=timezone.utc)  # 9:30 AM NY time (EDT, UTC-4)
